...
const LocationCard = () => {
  ...
  return (
    <div className='shadow-feature-card dark:shadow-feature-card-dark relative flex h-60 flex-col gap-6 overflow-hidden rounded-xl p-4 lg:p-6'>
      ...
      <div className='absolute inset-x-0 bottom-[-160px] mx-auto aspect-square h-[380px] [@media(max-width:420px)]:bottom-[-120px] [@media(max-width:420px)]:h-[320px] [@media(min-width:768px)_and_(max-width:858px)]:h-[350px]'>
        <div
          style={{
            width: '100%',
            height: '100%',
