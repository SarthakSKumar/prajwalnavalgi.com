  ...
  useEffect(() => {
    animate(
      [
        ...
        ['#micro-controllers', { opacity: 1 }, { duration: 0.3 }],
        ['#pointer', { left: 50, top: 102 }, { at: '+0.5', duration: 0.5, ease: 'easeInOut' }],
        ['#micro-controllers', { opacity: 0.4 }, { at: '-0.3', duration: 0.1 }],
        ['#embedded-c', { opacity: 1 }, { duration: 0.3 }],
        ['#pointer', { left: 224, top: 170 }, { at: '+0.5', duration: 0.5, ease: 'easeInOut' }],
        ['#embedded-c', { opacity: 0.4 }, { at: '-0.3', duration: 0.1 }],
        ['#firmware-development', { opacity: 1 }, { duration: 0.3 }],
        ['#pointer', { left: 88, top: 198 }, { at: '+0.5', duration: 0.5, ease: 'easeInOut' }],
        ['#firmware-development', { opacity: 0.4 }, { at: '-0.3', duration: 0.1 }],
        ['#rtos-soc', { opacity: 1 }, { duration: 0.3 }],
        ['#pointer', { left: 200, top: 60 }, { at: '+0.5', duration: 0.5, ease: 'easeInOut' }],
        ['#rtos-soc', { opacity: 0.4 }, { at: '-0.3', duration: 0.1 }]
      ],
      {
